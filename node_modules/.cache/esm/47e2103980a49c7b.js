let axios,chalk;_80a‍.x([["validateApiKey",()=>validateApiKey],["validateCityId",()=>validateCityId],["validateUnits",()=>validateUnits],["queryCurrentWeather",()=>queryCurrentWeather],["queryWeatherForecast",()=>queryWeatherForecast]]);_80a‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_80a‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);


       function validateApiKey(apiKey) {
  if (!apiKey || apiKey.length !== 32) {
    _80a‍.g.console.error(
      chalk.redBright(
  ...
  return true;
       ...
       async function queryCurrentWeather(cityId, units, apiKey) {
  ...
  return await axios({
    ...
    url: url
       ...
       async function queryWeatherForecast(cityId, units, apiKey) {
