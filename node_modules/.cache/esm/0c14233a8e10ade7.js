let Conf,Table,configKey,validateApiKey,validateCityId,validateUnits,queryWeatherForecast;_8e1‍.x([["forecast",()=>forecast]]);_8e1‍.w("conf",[["default",["Conf"],function(v){Conf=v}]]);_8e1‍.w("cli-table3",[["default",["Table"],function(v){Table=v}]]);_8e1‍.w("./configure",[["configKey",["configKey"],function(v){configKey=v}]]);_8e1‍.w("./utils",[["validateApiKey",["validateApiKey"],function(v){validateApiKey=v}],["validateCityId",["validateCityId"],function(v){validateCityId=v}],["validateUnits",["validateUnits"],function(v){validateUnits=v}],["queryWeatherForecast",["queryWeatherForecast"],function(v){queryWeatherForecast=v}]]);
  ...
  _8e1‍.g.console.log(table.toString());
}
